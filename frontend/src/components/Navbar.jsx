      ...
      <div className="container">
        ...
        >
          <ul className="navbar-nav">
            ...
            {user && (
              <li className="nav-item">
                <Link className="btn btn-warning" to={"/real-estates/new"}>
                  Novi oglas
                </Link>
              </li>
            )}
