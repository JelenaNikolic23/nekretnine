...
function HomePageCarousel() {
  return (
    ...
    >
      <SwiperSlide
        className="swiper-slide carousel-item-a intro bg-image text-start"
        style={{
          backgroundImage:
                ...
                <div className="col-lg-8">
                  <div className="intro-body">
                    <p className="intro-title-top">
                      Vise od 10 gradova <br />u Republici Srbiji
                    </p>
      ...
      <SwiperSlide
        ...
        style={{
          backgroundImage:
            "url(https://images.pexels.com/photos/2147149/pexels-photo-2147149.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)",
        }}
      >
        <div className="overlay overlay-a"></div>
        <div className="intro-content display-table">
